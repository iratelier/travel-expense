      ...
      function t(e, i) {
          ...
          (this.drag = function (e) {
            ...
            if (s.draggedAxis && s.contentWrapperEl) {
              var v = s.axis[s.draggedAxis].track,
                f =
                  null !== (r = null === (i = v.rect) || void 0 === i ? void 0 : i[s.axis[s.draggedAxis].sizeAttr]) &&
                  void 0 !== r
                    ? r
                    : 0,
                ...
                g = parseInt(
                  null !==
                    (a = null === (n = s.elStyles) || void 0 === n ? void 0 : n[s.axis[s.draggedAxis].sizeAttr]) &&
                    void 0 !== a
                    ? a
                    : '0px',
                  10,
              ...
              var x =
                  ...
                  (null !==
                    (h = null === (c = v.rect) || void 0 === c ? void 0 : c[s.axis[s.draggedAxis].offsetAttr]) &&
                  void 0 !== h
                    ? h
                    : 0) -
                ...
                y =
                  ((x =
                    'x' === s.draggedAxis && s.isRtl
                      ? (null !==
                          (d = null === (u = v.rect) || void 0 === u ? void 0 : u[s.axis[s.draggedAxis].sizeAttr]) &&
                        void 0 !== d
                          ? d
                          : 0) -
                        m.size -
              ...
              'x' === s.draggedAxis &&
                s.isRtl &&
                (y = (null === (p = t.getRtlHelpers()) || void 0 === p ? void 0 : p.isScrollingToNegative) ? -y : y),
        ...
        (this.onMouseMove = (function (t, e, i) {
          ...
          return (
            ...
            A(t, e, { leading: s, maxWait: e, trailing: r })
          );
      ...
      return (
        (t.getRtlHelpers = function () {
          ...
          return (
            ...
            (t.rtlHelpers = { isScrollOriginAtZero: r.left !== l.left, isScrollingToNegative: l.left !== o.left }),
            t.rtlHelpers
          );
        }),
        ...
        (t.prototype.getScrollbarSize = function (t) {
          ...
          var s,
            ...
            l =
              null !==
                (i = null === (e = this.axis[t].track.el) || void 0 === e ? void 0 : e[this.axis[t].offsetSizeAttr]) &&
              void 0 !== i
                ? i
                : 0,
            o = l / r;
        ...
        (t.prototype.positionScrollbar = function (e) {
          ...
          if (this.axis[e].isOverflowing && this.contentWrapperEl && l.el && this.elStyles) {
            ...
            (c =
              'x' === e &&
              this.isRtl &&
              (null === (s = t.getRtlHelpers()) || void 0 === s ? void 0 : s.isScrollOriginAtZero)
                ? -c
                : c),
              'x' === e &&
                this.isRtl &&
                (c = (null === (r = t.getRtlHelpers()) || void 0 === r ? void 0 : r.isScrollingToNegative) ? c : -c);
            var h = c / (o - a),
              u = ~~((n - l.size) * h);
            (u = 'x' === e && this.isRtl ? -u + (n - l.size) : u),
              (l.el.style.transform =
                'x' === e ? 'translate3d('.concat(u, 'px, 0, 0)') : 'translate3d(0, '.concat(u, 'px, 0)'));
          }
        }),
        ...
        (t.prototype.showScrollbar = function (t) {
          void 0 === t && (t = 'y'),
            this.axis[t].isOverflowing &&
              ...
              (_(this.axis[t].scrollbar.el, this.classNames.visible), (this.axis[t].scrollbar.isVisible = !0));
        }),
        (t.prototype.hideScrollbar = function (t) {
          void 0 === t && (t = 'y'),
            this.isDragging ||
              (this.axis[t].isOverflowing &&
                this.axis[t].scrollbar.isVisible &&
                (q(this.axis[t].scrollbar.el, this.classNames.visible), (this.axis[t].scrollbar.isVisible = !1)));
        }),
        ...
        (t.prototype.onMouseMoveForAxis = function (t) {
          ...
          e.track.el &&
            ...
            this.isWithinBounds(e.track.rect)
              ...
              : (q(e.track.el, this.classNames.hover), this.options.autoHide && this.hideScrollbar(t)));
        }),
        ...
        (t.prototype.onDragStart = function (t, e) {
          ...
          (this.axis[e].dragOffset =
            o - ((null === (i = l.rect) || void 0 === i ? void 0 : i[this.axis[e].offsetAttr]) || 0)),
            (this.draggedAxis = e),
        ...
        (t.prototype.onTrackClick = function (t, e) {
          ...
          if (this.options.clickOnTrack && n.scrollbar.el && this.contentWrapperEl) {
            ...
            var c =
                null !==
                  (s =
                    null === (i = this.axis[e].scrollbar.rect) || void 0 === i ? void 0 : i[this.axis[e].offsetAttr]) &&
                void 0 !== s
                  ? s
                  : 0,
              h = parseInt(
                null !== (l = null === (r = this.elStyles) || void 0 === r ? void 0 : r[this.axis[e].sizeAttr]) &&
                  void 0 !== l
                  ? l
                  : '0px',
                10,
              ...
              v = function () {
                o.contentWrapperEl &&
                  (-1 === d
                    ? u > p &&
                      ((u -= 40), (o.contentWrapperEl[o.axis[e].scrollOffsetAttr] = u), a.requestAnimationFrame(v))
                    : u < p &&
                      ((u += 40), (o.contentWrapperEl[o.axis[e].scrollOffsetAttr] = u), a.requestAnimationFrame(v)));
              };
            v();
            ...
            t.addedNodes.forEach(function (t) {
              1 === t.nodeType &&
                (t.hasAttribute('data-simplebar')
                  ? !i.instances.has(t) && document.documentElement.contains(t) && new i(t, F(t.attributes))
              ...
              t.removedNodes.forEach(function (t) {
                ...
                1 === t.nodeType &&
                  ('init' === t.getAttribute('data-simplebar')
                    ? !document.documentElement.contains(t) &&
                      (null === (e = i.instances.get(t)) || void 0 === e || e.unMount())
